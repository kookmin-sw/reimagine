  ...
  return (
    <section className="bg-gray-50 py-20 md:py-28">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="mb-16 text-center text-lg leading-relaxed text-gray-700 sm:text-xl">
          KMUCS Reimagine 2035! 는<br/>학생·교수·졸업생·타과생 등, <br className="block sm:hidden" />다양한 구성원의 의견을 반영하여<br />
