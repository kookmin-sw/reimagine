    ...
    >
      ...
      <div className="relative mx-auto flex min-h-screen max-w-5xl items-center justify-center py-24 text-center">
        <div>
          ...
          <p className="mb-6 text-xl font-light leading-relaxed text-blue-50">
          ...
          <div className="flex flex-col justify-center gap-6 sm:flex-row">
            <a
              ...
              className="inline-block cursor-pointer rounded-lg bg-white/92 px-10 py-4 text-xl font-medium text-blue-900 shadow-lg transition-all duration-200 hover:bg-white"
            >
              설문조사 참여하기
            </a>
          </div>
      ...
      <div className="pointer-events-none absolute bottom-10 left-1/2 flex -translate-x-1/2 flex-col items-center text-center">
        <p className="text-sm font-medium text-blue-50/95">
          아래로 내려 프로젝트 소개를 확인해 보세요
        </p>
